...
内网参考 clickhouse 版本: `v22.8.4.7-lts`
...
clickhouse 错误代码对照表 [errors define](https://github.com/ClickHouse/ClickHouse/blob/v22.8.4.7-lts/src/Common/ErrorCodes.cpp#L17)
